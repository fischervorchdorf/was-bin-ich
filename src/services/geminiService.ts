...
${isImageContent ? `
   ...
   - Ein konkretes Ereignis oder Schicksal mit dem Bildinhalt verknüpft
` : `
   - Erzähle eine spannende Geschichte, die das Artefakt im Mittelpunkt hat
   - Perspektive: Externe Erzählung (NICHT Ich-Form)
   - Ein konkretes Ereignis oder Schicksal mit dem Objekt verknüpft
`}
   - Länge: 1500-2000 Wörter
   - Stil: Mitreißend, fesselnd, wie ein historischer Roman
   - Fokus:
     * Zeige die Epoche lebendig und authentisch
     * Soziale Verhältnisse (Armut vs. Wohlstand) spürbar machen
     * Schwere des Lebens fühlbar machen
